...
export default {
  ...
  'flex-grow': 'croissance-de-la-flexibilité',
  'flex-shrink': 'contraction-de-la-flexibilité',
  'flex-wrap': 'emballage-de-la-flexibilité',
  'float': 'flottant',
  'font': 'typographie',
  'font-family (descriptor)': 'famille-de-la-typographie',
  'font-family (property)': 'famille-de-la-typographie',
  ...
  'font-stretch (descriptor)': 'étirement-de-la-typographie',
  'font-stretch (property)': 'étirement-de-la-typographie',
  'font-style (descriptor)': 'style-de-la-typographie',
  'font-style (property)': 'style-de-la-typographie',
  'font-synthesis': 'synthèse-de-la-typographie',
  'font-variant (descriptor)': 'variation-de-la-typographie',
  'font-variant (property)': 'variation-de-la-typographie',
  ...
  // 'font-variant-east-asian': '-de-la-typographie',
  // 'font-variant-ligatures': '-de-la-typographie',
  // 'font-variant-numeric': '-de-la-typographie',
  // 'font-variant-position': '-de-la-typographie',
  'font-weight (descriptor)': 'gras-de-la-typographie',
  'font-weight (property)': 'gras-de-la-typographie',
  // 'grad': '',
  // 'grayscale()': '',
  // 'grid': '',
  // 'grid-area': '',
